...
: new Sequelize(`postgres://${DB_USER}:${DB_PASSWORD}@${DB_HOST}:${DATABASE_PORT}/${DATABASE_NAME}`, {
...
const { SportsInstitutions, RollSettings, TableLogins, PlanUserNames, Entrenador } = sequelize.models;
